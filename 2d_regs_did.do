...
Intro: In this Do-file, we run DiD regs with the panel dataset
...
reghdfe employed i.pref_treat##i.after i.ai_treat##i.after i.ai_pref_treat##i.after bl_employed ///
i.bl_missing, absorb(month_enrollment month_answer i.strata ///
i.experimentcityid_e wave) vce(robust)
	lincom 1.pref_treat - 1.ai_treat
	local coef1 = r(estimate)
	local se1 = r(se)
	local t1 = `coef1'/`se1'
	local pv1 = r(p)
	
	lincom 1.pref_treat - 1.ai_pref_treat
	local coef2 = r(estimate)
	local se2 = r(se)
	local t2 = `coef1'/`se1'
	local pv2 = r(p)
	
	lincom 1.ai_treat - 1.ai_pref_treat
	...
	outreg2 using "$tables/2c_did_regs.txt", replace ctitle("Employment Status")  ///
...
*Search hours
{
reghdfe job_search_hours i.pref_treat##i.after i.ai_treat##i.after i.ai_pref_treat##i.after ///
bl_search_hours, absorb(month_enrollment month_answer i.strata ///
i.experimentcityid_e wave) vce(robust)
	lincom 1.pref_treat - 1.ai_treat
	local coef1 = r(estimate)
	local se1 = r(se)
	...
	outreg2 using "$tables/2c_did_regs.txt", append ctitle("Job Searching Hours")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
...
{
reghdfe job_search_applications i.pref_treat##i.after i.ai_treat##i.after i.ai_pref_treat##i.after ///
bl_applications, absorb(month_enrollment month_answer i.strata ///
i.experimentcityid_e wave) vce(robust)
	lincom 1.pref_treat - 1.ai_treat
	local coef1 = r(estimate)
	local se1 = r(se)
	...
	outreg2 using "$tables/2c_did_regs.txt", append ctitle("Job Applications")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')	
...
{
reghdfe job_search_interviews i.pref_treat##i.after i.ai_treat##i.after i.ai_pref_treat##i.after ///
bl_interviews, absorb(month_enrollment month_answer i.strata ///
i.experimentcityid_e wave) vce(robust)	
	lincom 1.pref_treat - 1.ai_treat
	local coef1 = r(estimate)
	local se1 = r(se)
	...
	outreg2 using "$tables/2c_did_regs.txt", append ctitle("Job Interviews")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')	
...
{
reghdfe job_search_offers i.pref_treat##i.after i.ai_treat##i.after i.ai_pref_treat##i.after ///
bl_job_offers, absorb(month_enrollment month_answer i.strata ///
i.experimentcityid_e wave) vce(robust)
	lincom 1.pref_treat - 1.ai_treat
	local coef1 = r(estimate)
	local se1 = r(se)
	...
	outreg2 using "$tables/2c_did_regs.txt", append ctitle("Job Offers")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
...
*clicks
{
reghdfe clicks i.pref_treat##i.after i.ai_treat##i.after i.ai_pref_treat##i.after, ///
...
i.experimentcityid_e wave) vce(robust)
	...
	outreg2 using "$tables/2c_did_regs.txt", append ctitle("Clicks")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
...
*saves
{
reghdfe saves i.pref_treat##i.after i.ai_treat##i.after i.ai_pref_treat##i.after, ///
absorb(month_enrollment month_answer i.strata ///
i.experimentcityid_e wave) vce(robust)
	lincom 1.pref_treat - 1.ai_treat
	local coef1 = r(estimate)
	...
	outreg2 using "$tables/2c_did_regs.txt", append ctitle("Saved Jobs")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
...
*hourly pay 
{
reghdfe hourly_pay_wins i.pref_treat##i.after i.ai_treat##i.after i.ai_pref_treat##i.after ///
bl_job_hourly_pay, absorb(month_enrollment month_answer i.strata ///
i.experimentcityid_e wave) vce(robust)
	lincom 1.pref_treat - 1.ai_treat
	local coef1 = r(estimate)
	local se1 = r(se)
	...
	outreg2 using "$tables/2c_did_regs.txt", append ctitle("Hourly Pay")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
...
*Job satisfaction
{
reghdfe sat_overall_e i.pref_treat##i.after i.ai_treat##i.after i.ai_pref_treat##i.after ///
bl_job_satisf, absorb(month_enrollment month_answer i.strata ///
i.experimentcityid_e wave) vce(robust)
	lincom 1.pref_treat - 1.ai_treat
	local coef1 = r(estimate)
	local se1 = r(se)
	...
	outreg2 using "$tables/2c_did_regs.txt", append ctitle("Job Satisfaction")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
...
*Tenure
{
reghdfe tenure i.pref_treat##i.after i.ai_treat##i.after i.ai_pref_treat##i.after ///
bl_tenure i.bl_tenure_missing, absorb(month_enrollment month_answer i.strata ///
i.experimentcityid_e wave) vce(robust)
	lincom 1.pref_treat - 1.ai_treat
	local coef1 = r(estimate)
	local se1 = r(se)
	...
	outreg2 using "$tables/2c_did_regs.txt", append ctitle("Tenure")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
