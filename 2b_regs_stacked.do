...
Intro: In this Do-file, we run stacked regs with the panel dataset
...
i.experimentcityid_e wave) vce(robust)
	...
	outreg2 using "$tables/2a_stacked_regs.txt", replace ctitle("Employment Status")  ///
...
i.experimentcityid_e wave) vce(robust)
	...
	outreg2 using "$tables/2a_stacked_regs.txt", append ctitle("Job Searching Hours")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
...
i.experimentcityid_e wave) vce(robust)
	...
	outreg2 using "$tables/2a_stacked_regs.txt", append ctitle("Job Applications")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')	
...
i.experimentcityid_e wave) vce(robust)	
	...
	outreg2 using "$tables/2a_stacked_regs.txt", append ctitle("Job Interviews")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')	
...
i.experimentcityid_e wave) vce(robust)
	...
	outreg2 using "$tables/2a_stacked_regs.txt", append ctitle("Job Offers")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
...
*clicks
{
reghdfe clicks pref_treat ai_treat ai_pref_treat, ///
...
i.experimentcityid_e wave) vce(robust)
	...
	outreg2 using "$tables/2a_stacked_regs.txt", append ctitle("Clicks")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
...
*saves
{
reghdfe saves pref_treat ai_treat ai_pref_treat  , ///
absorb(month_enrollment month_answer i.strata ///
i.experimentcityid_e wave) vce(robust)
	lincom pref_treat - ai_treat
	local coef1 = r(estimate)
	...
	outreg2 using "$tables/2a_stacked_regs.txt", append ctitle("Saved Jobs")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
...
i.experimentcityid_e wave) vce(robust)
	...
	outreg2 using "$tables/2a_stacked_regs.txt", append ctitle("Hourly Pay")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
...
i.experimentcityid_e wave) vce(robust)
	...
	outreg2 using "$tables/2a_stacked_regs.txt", append ctitle("Job Satisfaction")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
...
i.experimentcityid_e wave) vce(robust)
	...
	outreg2 using "$tables/2a_stacked_regs.txt", append ctitle("Tenure")  ///
	addstat("pref_treat - ai_treat", `coef1', "SE", `se1', "t-stat", `t1', "P-value", `pv1', ///
	"pref_treat - ai_pref_treat", `coef2', "SE", `se2', "t-stat", `t2', "P-value", `pv2', ///
	"ai_treat - ai_pref_treat", `coef3', "SE", `se3', "t-stat", `t3', ///
	"P-value", `pv3', "control_mean", `control_mean', "control_sd", `control_sd')
